			...
			<div className="container mx-auto px-4">
				<div className="text-center max-w-3xl mx-auto mb-16">
					...
					<p className="text-xl text-gray-600">
						Interested in joining TechSoc or have questions? We'd love to hear
						from you!
					</p>
				</div>
				...
				<div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
					...
					<div className="space-y-8">
						...
						<Card className="p-6 bg-gradient-to-br from-blue-600 to-purple-600 text-white">
							...
							<p className="mb-2">Join us every Thursday at 6:00 PM</p>
							<p className="text-blue-100">Engineering Building, Room 301</p>
						</Card>
					</div>
				</div>
			</div>
